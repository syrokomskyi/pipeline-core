...
# `@warpgogol/pipeline-core` — Agent Guide
...
| Entry point                             | Module                        |
| --------------------------------------- | ----------------------------- |
| `@warpgogol/pipeline-core/package.json` | `./package.json`              |
| `@warpgogol/pipeline-core`              | `./src/index.ts`              |
| `@warpgogol/pipeline-core/phase`        | `./src/lib/pipeline-phase.ts` |
| `@warpgogol/pipeline-core/step`         | `./src/lib/pipeline-step.ts`  |
